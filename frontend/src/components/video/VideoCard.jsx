...
const VideoCard = ({ video }) => {
  ...
  const renderTimeAndSubtitles = () => {
    ...
    if (!hasSubtitles) {
      return (
        <p className="text-gray-600 dark:text-gray-400 text-[17px] mt-3 opacity-50 font-medium">
          {timeText}
        </p>
      );
    }
    ...
    >
      ...
      <div className="px-4 md:px-0 mt-3">
        ...
        {video.createdByUsername && (
          <p className="text-gray-600 dark:text-gray-400 text-[17px] mt-1 font-medium">
        ...
        {/* Upload time */}
        {video.createdAt && (
          <p className="text-gray-600 dark:text-gray-400 text-[17px] mt-1 opacity-50 font-medium">
