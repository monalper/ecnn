    ...
    return (
      ...
      >
        ...
        <div className={`${mobileLayout ? 'block' : 'block lg:hidden'}`}>
          ...
          <div className={`px-4 md:px-0 ${mobileLayout ? 'mt-4' : 'mt-2'}`}>
            <h3 className={`${mobileLayout ? 'text-[20px]' : 'text-[20px]'} font-bold text-gray-900 dark:text-white line-clamp-2 leading-tight`}>
              {video.title}
            </h3>
        ...
        <div className={`${mobileLayout ? 'hidden' : 'hidden lg:flex'} space-x-4`}>
          ...
          <div className="flex-1 min-w-0" style={{ width: '200px', maxWidth: '250px' }}>
            <h3 className="text-[20px] font-bold text-gray-900 dark:text-white line-clamp-2 mb-2 leading-tight">
              {video.title}
            </h3>
            {renderTimeAndSubtitles()}
          </div>
