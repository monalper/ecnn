  ...
  const editor = useEditor({
    extensions: [
      ...
      TableHeader.configure({
        HTMLAttributes: {
          class: 'border border-gray-300 dark:border-gray-600 p-2 bg-gray-100 dark:bg-gray-700 font-semibold text-gray-700 dark:text-gray-300',
        },
      }),
      Color,
      TextStyle,
...
>>>>>>> f3eb23d59c213da59111a603fb32a1b88604e8cb
    ...
    editorProps: {
      attributes: {
        class: 'min-h-[200px] p-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none prose prose-gray dark:prose-invert max-w-none text-gray-900 dark:text-gray-100',
      },
    },
  });
  ...
  // Load KaTeX globally for math rendering
  useEffect(() => {
  ...
  const inputClass = "block w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors sm:text-sm placeholder-gray-400 dark:placeholder-gray-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100";
  const labelClass = "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5";

  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {formError && (
        <div className="p-3 mb-4 bg-red-50 dark:bg-red-900/20 border border-red-300 dark:border-red-700 text-red-700 dark:text-red-400 rounded-lg text-sm">
          {formError}
        </div>
      )}
      <div>
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Birden fazla kategori seçmek için Ctrl (Windows) veya Cmd (Mac) tuşunu basılı tutun.</p>
      </div>
      <div>
        ...
        <div className="border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800">
          ...
          />
          {/* Toolbar */}
          <div className="flex flex-wrap gap-2 p-2 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700 rounded-b-lg">
            <button
              type="button"
            ...
            <div className="relative inline-block">
              <select
                ...
                className="p-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm"
                title="Font Ailesi"
              >
...
>>>>>>> f3eb23d59c213da59111a603fb32a1b88604e8cb
      ...
      <div>
        ...
        {imagePreview && !isUploading && (
          <div className="mt-3 p-2 border border-gray-200 dark:border-gray-700 rounded-lg inline-block">
