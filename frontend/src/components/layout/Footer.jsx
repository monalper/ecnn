      ...
      <div className={`footer-mobile-optimized ${isDark ? 'bg-[#0F0F0F] border-t border-[#E0D9C9]/20' : 'bg-gradient-to-br from-gray-50 to-gray-100 border-t border-gray-300'} px-6 sm:px-8 lg:px-8 xl:px-12 2xl:px-16 py-16 lg:py-20 xl:py-24`}>
        <div className="w-full mx-auto max-w-7xl">
          ...
          <div className="hidden lg:flex items-end justify-between mb-16 lg:mb-20">
            ...
            <div className="flex gap-8 max-w-[480px]">
          ...
          <div className="lg:hidden">
            ...
            <div className="flex justify-center mb-16">
              <div className="footer-nav-mobile flex flex-wrap justify-center gap-8">
                ...
                <a href="/apod" className={`footer-nav-link-mobile ${isDark ? 'text-[#E0D9C9] hover:text-white' : 'text-gray-600 hover:text-gray-900'} text-base font-semibold uppercase tracking-wide transition-colors duration-200 hover:scale-105 transform`}>
                  Nasa Apod
                </a>
                <a href="/moon" className={`footer-nav-link-mobile ${isDark ? 'text-[#E0D9C9] hover:text-white' : 'text-gray-600 hover:text-gray-900'} text-base font-semibold uppercase tracking-wide transition-colors duration-200 hover:scale-105 transform`}>
                  Ay Evreleri
                </a>
                <a href="/asteroid" className={`footer-nav-link-mobile ${isDark ? 'text-[#E0D9C9] hover:text-white' : 'text-gray-600 hover:text-gray-900'} text-base font-semibold uppercase tracking-wide transition-colors duration-200 hover:scale-105 transform`}>
                  Asteroid İzleme
                </a>
