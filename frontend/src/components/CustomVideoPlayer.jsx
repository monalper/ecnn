                  ...
                  {currentSettingsView === 'main' && (
                    <div className="space-y-1">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between px-4 py-3 text-base rounded-lg hover:bg-white/15 transition-colors text-white/90 hover:text-white"
                      >
                        <div className="flex items-center">
                          <FiClock className="w-5 h-5 text-white/70 mr-4" />
                      ...
                      >
                        <div className="flex items-center">
                          <FiMonitor className="w-5 h-5 text-white/70 mr-4" />
                      ...
                      {(subtitleTracks.length > 0 || (subtitles && subtitles.length > 0)) && (
                        ...
                        >
                          <div className="flex items-center">
                            <FiType className="w-5 h-5 text-white/70 mr-4" />
                      ...
                      <div className="grid grid-cols-3 gap-2 px-2 pb-2">
                        {[0.5, 0.75, 1, 1.25, 1.5, 2].map((speed) => (
                          <button
                            ...
                            className={`px-4 py-3 text-base rounded-lg transition-colors font-medium ${
                              speed === playbackSpeed 
                  ...
                  {currentSettingsView === 'subtitles' && (
                    <div className="space-y-2">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-3 text-base rounded-lg transition-colors font-medium ${
                          showSubtitles 
                      ...
                      {showSubtitles && subtitleTracks.length > 0 && (
                        <div className="pt-3 border-t border-white/20">
                          <div className="text-white/60 text-sm mb-3 px-4 font-medium">Altyazı Seç:</div>
                          <div className="space-y-1">
