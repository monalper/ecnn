  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-full px-4 py-3 bg-white dark:bg-gray-800 rounded-lg transition-all duration-200 focus:outline-none"
      >
      ...
      {/* Dropdown Calendar */}
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-lg z-50 overflow-hidden">
          {/* Calendar Header */}
