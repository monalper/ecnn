            ...
            <div className="w-[280px] sm:w-[320px] md:w-[360px] mt-8 mx-auto px-2 sm:px-0">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg bg-white rounded-full shadow-md focus:ring-2 focus:ring-brand-orange/30 outline-none transition-all duration-200 placeholder:text-slate-400"
                />
