      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="inline-flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-500">
            <span>Kapsül şekli:</span>
            <div className="w-6 h-3 loading-capsule rounded-full animate-pulse"></div>
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-500 mt-2">
            Aydınlık tema: Kırmızı kenarlık (#FF0000) | Karanlık tema: Beyaz kenarlık (#FFFFFF)
          </p>
        </div>
      </div>
    </div>
