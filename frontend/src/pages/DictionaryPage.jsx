      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="max-w-md mx-auto mb-12">
          <input
            ...
            className="w-full px-6 py-4 text-lg border-0 rounded-2xl bg-white dark:bg-slate-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-[#f5f5f5] focus:outline-none focus:ring-2 focus:ring-blue-500/20 shadow-sm transition-all duration-200"
          />
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {filteredEntries.map(entry => (
                  <Link
                    ...
                    key={entry.word}
                    className="group block p-6 bg-white dark:bg-slate-800 rounded-2xl transition-all duration-300 ease-out border border-gray-50 dark:border-slate-700/50 hover:border-gray-100 dark:hover:border-slate-600 hover:bg-gray-50/50 dark:hover:bg-slate-750 hover:shadow-sm hover:-translate-y-0.5"
                  >
