...
const { verifyToken, isAdmin, optionalVerifyToken } = require('../middlewares/auth.middleware');
const videoController = require('../controllers/video.controller');

// Public routes (no authentication required)
router.get('/', videoController.getAllVideoItems);
router.get('/:id', optionalVerifyToken, videoController.getVideoWithLikeStatus);
router.post('/:id/like', verifyToken, videoController.toggleVideoLike);
