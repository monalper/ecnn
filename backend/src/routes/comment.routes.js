...
router.get('/article/:articleSlug', commentController.getCommentsByArticle);

// POST /api/comments -> Yeni yorum oluştur (optional auth for admin privileges)
router.post('/', optionalVerifyToken, commentController.createComment);
...
// DELETE /api/comments/:commentId -> Yorumu sil (admin)
router.delete('/:commentId', verifyToken, isAdmin, commentController.deleteComment);
